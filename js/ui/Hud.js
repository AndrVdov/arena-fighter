...
class Hud {
  ...
  static ICONS = {
    ...
    logout: '<path d="M13 4h6v16h-6M15 12H5M9 8l-4 4 4 4"/>',
    support: '<path d="M8 3h8M9 3v3.5C7.1 8 6 10.4 6 13v6a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-6c0-2.6-1.1-5-3-6.5V3"/><path d="M12 17.5s-3-1.8-3-4a1.7 1.7 0 0 1 3-1.1 1.7 1.7 0 0 1 3 1.1c0 2.2-3 4-3 4Z"/>',
    ...
    victory: '<path d="M7.5 20C4.6 17.8 3.3 14.5 4 10M16.5 20c2.9-2.2 4.2-5.5 3.5-10M5.2 13 2.8 11M6.5 16l-3 .2M8.5 19l-2.8 1M18.8 13l2.4-2M17.5 16l3 .2M15.5 19l2.8 1"/><path d="m12 3 1.5 3.1 3.4.5-2.5 2.4.6 3.4-3-1.6-3 1.6.6-3.4-2.5-2.4 3.4-.5L12 3Z"/>',
    defeat: '<path d="M12 2.5 20 5.5v6.2c0 5.2-3.2 8.4-8 10-4.8-1.6-8-4.8-8-10V5.5l8-3Z"/><path d="m13.5 3.2-4 7.3 4 2-4 7.2"/>',
  };
